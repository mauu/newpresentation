...
import { CjShoppingCartComponent } from './cj-shopping-cart.component';
...
var TestHostComponent = (function () {
    function TestHostComponent() {
        this.headerTitleText = 'Titolo Carrello';
        this.dataText = model;
    }
...
TestHostComponent = __decorate([
    Component({
        selector: 'demo-cjShoppingCart',
        template: "\n  <cj-shopping-cart\n  [cjHeaderTitle] = \"headerTitleText\"\n  [cjData] = \"dataText\"\n  >\n  </cj-shopping-cart>\n  "
    }),
    __metadata("design:paramtypes", [])
], TestHostComponent);
export { TestHostComponent };
describe('CjShoppingCartComponent Test', function () {
    var component;
    var fixture;
