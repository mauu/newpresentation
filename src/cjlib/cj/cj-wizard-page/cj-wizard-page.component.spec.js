...
__decorate([
    ViewChild(CjWizardPageComponent),
    __metadata("design:type", CjWizardPageComponent)
], TestHostComponent.prototype, "innerWizardPage", void 0);
...
describe('Testing CjWizardPage Component', function () {
    var hostComponent;
    var fixture;
    var cjWizardElement;
    ...
    beforeEach(async(function () {
        ...
        spyOn(hostComponent.innerWizardStep, 'addPage').and.callThrough();
    ...
    it('should be created', function () {
        ...
        expect(hostComponent.innerWizardPage).toBeTruthy();
    });
    it('should call registration from parent component', function () {
        expect(hostComponent.innerWizardStep.addPage).toHaveBeenCalled();
    });
    it('should passing itself to the parent component registration', function () {
        expect(hostComponent.innerWizardStep.addPage).toHaveBeenCalledWith(hostComponent.innerWizardStep._pages[0]);
    });
});
